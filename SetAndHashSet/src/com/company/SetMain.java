...
public class SetMain {
    public static void main(String[] args) {
        ...
        Set<Integer> UninioSet = new HashSet<>(squares);
        UninioSet.addAll(cubes);
        System.out.println("Union contains " + UninioSet.size() + " elements");


        Set<Integer> IntersectionSet = new HashSet<>(squares);
        IntersectionSet.retainAll(cubes);
